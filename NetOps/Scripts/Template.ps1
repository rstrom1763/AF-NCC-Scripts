...
$computers = Get-Content "C:\Users\1086335782C\Desktop\list.txt"
...
ForEach($computer in $computers)
{
    ...
    else
    {
        ...
        #Copy-Item "\\$Server\McConnell_Public\Patching\Plugins\$Plugin\Deploy\*" "\\$computer\C$\installfiles\Deploy\" -Recurse -Force -ErrorAction SilentlyContinue
