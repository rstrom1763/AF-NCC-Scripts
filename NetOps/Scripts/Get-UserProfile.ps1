...
[string[]]$ComputerName = $env:computername, [string]$UserName
)            

$ComputerName = Get-Content "C:\Users\1086335782C\Desktop\AMXS.txt"
...
$OutputObj | Out-File "C:\Users\1086335782C\Desktop\profiles.txt"